...
autoparse-sync-done = Синхронизация: <b>{ $inserted }</b> новых, { $skipped } уже в приложении, { $total } на hh.ru. ❤️ В лайках этой компании (лента): <b>{ $liked_in_feed }</b> вакансий. Подтянуто с hh.ru в компанию: <b>{ $vacancies_imported }</b>.
