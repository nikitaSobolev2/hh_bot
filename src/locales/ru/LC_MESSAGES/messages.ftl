...
iv-questions-to-ask-senior-teaser = Если хочешь, я могу сделать ещё более «охотничий» список вопросов, чтобы прямо на собеседовании выделяться и показать глубокое понимание стека и процессов компании. Это будут вопросы уровня Senior+.
