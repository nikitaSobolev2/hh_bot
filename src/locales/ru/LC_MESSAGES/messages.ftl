...
autoparse-confirm-rebuild-pool = Пересобрать пул вакансий этого автопарсера только по его URL поиска и ключевым словам? Это очистит сохранённые вакансии, сессии ленты, лайки и дизлайки по этой компании, а затем запустит новый прогон.
...
autoparse-rebuild-pool-started = Пул вакансий очищен. Запущен новый прогон автопарсинга.
