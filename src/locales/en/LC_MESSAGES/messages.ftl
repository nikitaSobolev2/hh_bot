...
autoparse-confirm-rebuild-pool = Rebuild this autoparser's vacancy pool from its own search URL and keywords? This clears stored vacancies plus feed sessions, likes, and dislikes for this company, then starts a fresh run.
...
autoparse-rebuild-pool-started = Vacancy pool reset. Fresh autoparse run started.
