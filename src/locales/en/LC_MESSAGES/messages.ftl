...
autoparse-confirm-reset-likes = Clear all liked vacancies from your history? This affects every autoparse feed session.
autoparse-confirm-reset-dislikes = Clear all disliked vacancies from your history? This affects every autoparse feed session.
