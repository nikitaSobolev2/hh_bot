...
hh-accounts-browser-err-not-logged-in = The file has hh.ru cookies, but the session is not logged in. Log in first and export storage_state again.
...
hh-login-assist-success-different-account = hh.ru session saved to the matching linked account. The session belonged to a different HeadHunter profile than the one you selected.
...
feed-pick-hh-browser-required = This feed currently requires an account with a saved hh.ru browser session.
feed-pick-hh-api-required = This feed currently requires an OAuth-linked HeadHunter account.
...
autoparse-parse-mode-prompt = Choose the parse mode:
autoparse-parse-mode = Parse mode
...
autoparse-parse-account-ready = [session]
autoparse-parse-account-pick = This filter uses the resume parameter, so web parsing needs an HH account with a saved browser session. Choose an account:
autoparse-parse-login-required = This web filter requires HH.ru authorization. Log in now or open HH accounts, then press “Continue after login”.
autoparse-parse-login-for-account = The account <b>{ $label }</b> has no saved browser session. Log in now, then press “Continue after login”.
autoparse-parse-login-now = Log in now
autoparse-parse-continue-after-login = Continue after login
autoparse-parse-open-hh-accounts = Open HH accounts
autoparse-parse-login-started = Server login has started. After login succeeds, press “Continue after login”.
autoparse-parse-login-followup = When login finishes, return here and press “Continue after login”.
autoparse-parse-no-login-assist = Server-side login is unavailable. Open HH accounts and import storage_state, then press “Continue after login”.
...
autoparse-detail-keyword-check = Keyword check
autoparse-detail-parse-mode = Parse mode
...
autoparse-edit-parse-mode = ✏️ Parse mode
autoparse-edit-parse-mode-saved = ✅ Parse mode updated.
...
autorespond-rename = ✏️ Rename autorespond
autorespond-rename-prompt = Enter a new name for this autorespond (current: { $current }):
autorespond-rename-empty = Name cannot be empty.
autorespond-rename-saved = ✅ Autorespond name updated.
...
autoparse-run-error-no-session = ❌ Web parsing did not start: this filter requires a saved HH.ru browser session.
autoparse-run-error-session-expired = ❌ Web parsing did not start: the HH.ru browser session has expired. Log in again and retry.
...
autoparse-keyword-check-enable = ✅ Enable keyword check
autoparse-keyword-check-disable = ⏸️ Disable keyword check
autoparse-toggle-keyword-check-enabled = ✅ Keyword check enabled
autoparse-toggle-keyword-check-disabled = ⏸️ Keyword check disabled
...
autoparse-btn-rebuild-pool = ♻️ Rebuild vacancy pool
...
autoparse-confirm-rebuild-pool = Rebuild this autoparser's vacancy pool? This clears stored vacancies plus feed sessions, likes, and dislikes for this company, but does not start a fresh run.
...
autoparse-rebuild-pool-started = Vacancy pool reset. No fresh autoparse run was started.
...
progress-group-line = <i>Step { $current } of { $total }{ $part2 }</i>
progress-step-negotiations-sync = 🔄 Sync negotiations (HH)
progress-step-autorespond-applications = 📨 Applications & responses
progress-step-autoparse-pipeline = 🌐 Autoparse
progress-step-parsing-pipeline = 🔎 Parsing
progress-step-autorespond-pipeline = 📨 Autorespond
progress-pipeline-manual-title = Autoparse → Autorespond
progress-taskgroup-title = Task group
progress-taskgroup-macro-bar = Group steps
progress-taskgroup-detail-bar = Current step
progress-taskgroup-nested-header = Sub-steps
progress-generic-working = Working…
progress-processing = ⏳ Processing...
progress-group-kind-autoparse-short = Autoparse
progress-group-kind-autorespond-short = Autorespond
progress-group-kind-parsing-short = Parsing
progress-summary-parsed = 🔎 Parsed vacancies: { $count }
progress-summary-autoparse-found = 🌐 New vacancies found: { $count }
progress-summary-synced = 🔄 Negotiations synced: { $count }
progress-summary-responded = 📨 Responses processed: { $count }
progress-summary-errors = ❌ Errors: { $count }
progress-summary-tests = 🧪 Vacancies with employer test: { $count }
negotiations-progress-title = 🔄 Negotiations sync
