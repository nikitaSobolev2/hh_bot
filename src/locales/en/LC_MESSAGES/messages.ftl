...
autoparse-sync-done = Negotiations synced: <b>{ $inserted }</b> new, { $skipped } already in app, { $total } seen on hh.ru. ❤️ Liked in this company (feed): <b>{ $liked_in_feed }</b> vacancies. Fetched from hh.ru into this company: <b>{ $vacancies_imported }</b>.
