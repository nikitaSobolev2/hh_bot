...
MANAGED_SETTINGS = [
    ...
    ("task_integrate_duties_enabled", "Integrate Duties Task Enabled", "toggle"),
    ...
    ("cb_integrate_duties_failure_threshold", "CB Integrate Duties Failure Threshold", "text"),
    ("cb_integrate_duties_recovery_timeout", "CB Integrate Duties Recovery Timeout (s)", "text"),
