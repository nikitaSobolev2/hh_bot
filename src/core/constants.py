...
class TaskName(StrEnum):
    ...
    INTEGRATE_DUTIES_TO_WORK_EXPERIENCE = "ai.integrate_duties_to_work_experience"
    ...
    GENERATE_COMPANY_REVIEW = "interviews.generate_company_review"
    GENERATE_QUESTIONS_TO_ASK = "interviews.generate_questions_to_ask"
    GENERATE_EMPLOYER_QUESTION_ANSWER = "interviews.generate_employer_question_answer"
...
class AppSettingKey(StrEnum):
    ...
    TASK_INTEGRATE_DUTIES_ENABLED = "task_integrate_duties_enabled"
    ...
    TASK_COMPANY_REVIEW_ENABLED = "task_company_review_enabled"
    TASK_QUESTIONS_TO_ASK_ENABLED = "task_questions_to_ask_enabled"
    TASK_EMPLOYER_QUESTION_ANSWER_ENABLED = "task_employer_question_answer_enabled"
    ...
    CB_INTEGRATE_DUTIES_FAILURE_THRESHOLD = "cb_integrate_duties_failure_threshold"
    CB_INTEGRATE_DUTIES_RECOVERY_TIMEOUT = "cb_integrate_duties_recovery_timeout"
    ...
    CB_COMPANY_REVIEW_FAILURE_THRESHOLD = "cb_company_review_failure_threshold"
    CB_COMPANY_REVIEW_RECOVERY_TIMEOUT = "cb_company_review_recovery_timeout"
    CB_QUESTIONS_TO_ASK_FAILURE_THRESHOLD = "cb_questions_to_ask_failure_threshold"
    CB_QUESTIONS_TO_ASK_RECOVERY_TIMEOUT = "cb_questions_to_ask_recovery_timeout"
    CB_EMPLOYER_QUESTION_ANSWER_FAILURE_THRESHOLD = "cb_employer_question_answer_failure_threshold"
    CB_EMPLOYER_QUESTION_ANSWER_RECOVERY_TIMEOUT = "cb_employer_question_answer_recovery_timeout"
